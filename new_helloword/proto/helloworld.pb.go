...
type HelloRequest struct {
	...
	Name string `protobuf:"bytes,1,opt,name=name,proto3" json:"name,omitempty"` //1是字段的唯一标识，不是字段的顺序是1，也不是name值是1
}
...
var file_helloworld_proto_rawDesc = []byte{
	...
	0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x07, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x32, 0x2f,
	0x0a, 0x05, 0x48, 0x65, 0x6c, 0x6c, 0x6f, 0x12, 0x26, 0x0a, 0x08, 0x53, 0x61, 0x79, 0x48, 0x65,
